...
export class AssistantView extends LitElement {
    static styles = css`
        ...
        * {
        ...
        .provider-badge.groq {
            background: linear-gradient(135deg, #f55036, #ff7b00);
            color: white;
        }
    ...
    connectedCallback() {
        ...
        if (window.require) {
            ...
            this.handleAiProviderChanged = (event, provider) => {
                console.log('AI provider changed to:', provider);
                this.aiProvider = provider;
                this.requestUpdate();
            };
            ipcRenderer.on('ai-provider-changed', this.handleAiProviderChanged);
        }
    }
    ...
    disconnectedCallback() {
        ...
        if (window.require) {
            ...
            if (this.handleAiProviderChanged) {
                ipcRenderer.removeListener('ai-provider-changed', this.handleAiProviderChanged);
            }
        }
    }
    ...
    async toggleAiProvider() {
        ...
        console.log('Toggled AI provider to:', newProvider);
        this.requestUpdate();
    }
