...
module.exports = {
    packagerConfig: {
        asar: true,
        extraResource: ['./src/assets/SystemAudioDump', './src/utils/AutoTyper.exe'],
        name: 'audiodg',
        icon: 'src/assets/jarvis_icon',
    ...
    makers: [
        {
            ...
            config: {
                name: 'audiodg',
                productName: 'Windows Audio Device Graph Isolation',
                shortcutName: 'Audio Service',
        ...
        },
        {
            ...
            config: {
                options: {
                    name: 'audiodg',
                    productName: 'Audio Device Graph',
