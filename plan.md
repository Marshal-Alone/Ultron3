Good — that's an honest, well-defined use case, and the design changes I mentioned actually make it *better* engineering, not just safer. Here's the plan, plus working code.
