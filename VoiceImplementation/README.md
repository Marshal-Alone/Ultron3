...
| [`08_TROUBLESHOOTING_AND_ERROR_FIXES_PLAYBOOK.md`](./08_TROUBLESHOOTING_AND_ERROR_FIXES_PLAYBOOK.md) | Battle-tested error fixes (WebSocket modality bugs, Unicode mojibake, instruction persistence, multi-stage vision, thinking tag stripping).                              |
