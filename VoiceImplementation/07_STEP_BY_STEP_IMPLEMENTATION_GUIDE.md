...
- [ ] _Verification_: Verify audio chunks are streaming over IPC and log sample rates and RMS energy.
...
- [ ] _Verification_: Speak into microphone or play audio; verify live diarized text appears in console logs.
...
- [ ] _Verification_: Verify responses stream into the UI in under 400ms.
...
- [ ] _Verification_: Test in airplane mode with no internet connection.
